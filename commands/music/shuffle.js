...
module.exports = class ShuffleQueueCommand extends Command {
  ...
  run(message) {
   ...
   // if (!message.member.permissions.has("MANAGE_CHANNELS") && message.guild.me.permissions.has("MANAGE_CHANNELS")) return message.channel.send("Only author can shuffle :)");
    if (
