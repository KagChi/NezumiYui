...
//const registerFont = require('cdn.glitch.com/6ba31500-de54-4e0f-b8ac-2c01e97125aa%2FPinky%20Cupid.otf','canvas');
//const registerFont = ('https://cdn.glitch.com/6ba31500-de54-4e0f-b8ac-2c01e97125aa%2FPinky%20Cupid.otf?v=1588510578866');
const percentColors = [
...
module.exports = class FriendshipCommand extends Command {
	...
	async run(msg, { first, second }) {
		...
		//	ctx.fillText(`${this.client.user.username}\`s Friedship Meter `, 600, 15);
			ctx.fillStyle = 'white';
